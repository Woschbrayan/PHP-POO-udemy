...
class CarregarPgAdm
{
    ...
    public function loadPage(string|null $urlController, string|null $urlMetodo, string|null $urlParameter): void
    {
        ...
        if (class_exists($this->classLoad)) {
            ...
            die("Erro - 003: Por favor tente novamente. Caso o problema persista, entre em contato o administrador " . ADMEMAIL);
    ...
    private function loadMetodo(): void
    {
        ...
        if (method_exists($classLoad, $this->urlMetodo)) {
            ...
            die("Erro - 004: Por favor tente novamente. Caso o problema persista, entre em contato o administrador " . ADMEMAIL);
        }
    }
