...
/**
 * Classe genêrica para validar o usuario único, somente um cadatrado pode utilizar o usuario
 *
 * @author Celke
 */
class AdmsValUserSingleLogin
{
    /** @var string $email Recebe o usuario que deve ser validado */
    private string $user;

    /** @var bool|null $edit Recebe a informação que é utilizada para verificar se é para validar usuario para cadastro ou edição */
